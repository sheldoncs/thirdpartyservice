...
public class ActiveDirectory {
   ...
   */
    public static boolean getConnection(String username, String password) throws NamingException {
   ...
   */
    public static boolean getConnection(String username, String password, String domainName) throws NamingException {
...
//        String ldapURL = "ldap://" + ((serverName==null)? domainName : serverName + "." + domainName) + '/';
    ...
    public static String getUserAttributes(String username, LdapContext ctx) {
    	String email = "";
        try {
            ...
            etc.. 
           "cavehill.uwi.edu","cavehillsrv1"
           ,DC=com
            */
            String[] attrIDs = { "mail" };
            constraints.setReturningAttributes(attrIDs);
            NamingEnumeration<SearchResult> answer = ctx.search("DC=cavehill.uwi.edu", "sAMAccountName=" + username, constraints);
            if (answer.hasMore()) {
   ...
   */
    public static class User {
        ...
        public User(Attributes attr) throws javax.naming.NamingException {
            ...
            email = (String) attr.get("email").get();
        }
